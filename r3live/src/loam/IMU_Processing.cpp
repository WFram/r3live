...
void ImuProcess::set_imu_intrinsic(double n_a, double n_omega, double n_b_a, double n_b_omega) {
    COV_START_ACC_DIAG = n_a;
    COV_START_GYRO_DIAG = n_omega;
    COV_BIAS_ACC_NOISE_DIAG = n_b_a;
    COV_BIAS_GYRO_NOISE_DIAG = n_b_omega;

    COV_OMEGA_NOISE_DIAG = n_omega;
    COV_ACC_NOISE_DIAG = n_a;
    COV_GYRO_NOISE_DIAG = n_omega;
}
...
StatesGroup ImuProcess::imu_preintegration(const StatesGroup &state_in, std::deque<sensor_msgs::Imu::ConstPtr> &v_imu,
                                           double end_pose_dt) {
    ...
    if (imu_need_init_) {
        ...
        if (init_iter_num > MAX_INI_COUNT) {
            ...
            ROS_INFO(
                    ...
                    stat.gravity[0], stat.gravity[1], stat.gravity[2], stat.bias_g[0], stat.bias_g[1], stat.bias_g[2],
                    cov_acc[0],
